...
type StepFactory (uidResolver: Guid -> string * string) as this =
    ...
    member private _.makeDataChangeStep<'TPolicyRecord, 'TStepResults when 'TPolicyRecord :> IPolicyRecord>
    ...
    member _.opening<'TPolicyRecord, 'TStepResults when 'TPolicyRecord :> IPolicyRecord>
    ...
    member _.removeExited<'TPolicyRecord, 'TStepResults when 'TPolicyRecord :> IPolicyRecord> ()
    ...
    member _.moveToClosingExistingData<'TPolicyRecord, 'TStepResults when 'TPolicyRecord :> IPolicyRecord>
    ...
    member _.addNewRecords<'TPolicyRecord, 'TStepResults when 'TPolicyRecord :> IPolicyRecord>
